...
namespace IdokladSdk.Requests.IssuedInvoice.Filter
{
    ...
    public class IssuedInvoiceFilter : IdFilter
    {
        ...
        /// <inheritdoc cref="IssuedInvoiceListGetModel.DateOfTaxing"/>
        ...
        public SemanticSearchFilterItem<string> Description { get; set; } = new SemanticSearchFilterItem<string>(nameof(IssuedInvoiceListGetModel.Description));
